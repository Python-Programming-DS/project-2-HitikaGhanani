...
# the constructor
    ...
    def aimodelMove(self):
        ...
        best_move = self.model.predict([flat_board]) [0]
    ...
    def playGame(self):
        ...
        while True:
            if self.turn == "X":
                ...
                print("Please enter row number and column number separated by comma.")
